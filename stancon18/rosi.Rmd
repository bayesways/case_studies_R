---
title: "Assesing the Safety of Rosiglitazone for the Treatment of Type II Diabetes"
author:
...
For this case study we use the Bernoulli likelihood for the binary data with a logit link function and allow for a measurement error for the continuous variables. We also assume that all latent variables have unit variance. The Stan program encoding this model is the following: 
