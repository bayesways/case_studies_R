...
final_score_C <- final_score(readRDS("./syn_fit_control.rds"))
final_score_T <- final_score(readRDS("./syn_fit_treat.rds"))
...
```
We observe that under this model, the final score is above 0 with probability 70% for a new patient. We can also make a plot of the difference to visualize the final result. 
